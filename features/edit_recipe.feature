...
Background: 
    ...
    And Exists the Nutrient "Nutrient2" and the description "Description2"
...
Scenario: Logged user edit Ingredients
    ...
    Then I can see recipe ingredient "Ingredient1" with quantity "1.00g"
    Then I can see recipe ingredient "Ingredient2" with quantity "1.00g"
    And I can see recipe nutrient "Nutrient1" with quantity "1.00g"
    And I can see recipe nutrient "Nutrient2" with quantity "1.00g"
