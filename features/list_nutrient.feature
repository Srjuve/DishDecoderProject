...
Scenario: User search nutrients
    Given Exists a nutrient with name "nutrient1" and the description "Description1"
    And Exists a nutrient with name "nutrient2" and the description "Description2"
